        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
            ...
            <div class="bg-white rounded-xl shadow border p-5 flex items-start gap-4">
                ...
                <div class="min-w-0">
                    ...
                    <p class="text-xl font-bold text-slate-800 mt-0.5 truncate">Rp
                        {{ number_format($ringkasan['total_penjualan'], 0, ',', '.') }}</p>
            ...
            <div class="bg-white rounded-xl shadow border p-5 flex items-start gap-4">
                ...
                <div class="min-w-0">
                    ...
                    <p class="text-xl font-bold text-slate-800 mt-0.5 truncate">Rp
                        {{ number_format($saldo['piutang'], 0, ',', '.') }}</p>
            ...
            <div class="bg-white rounded-xl shadow border p-5 flex items-start gap-4">
                ...
                <div class="min-w-0">
                    ...
                    <p class="text-xl font-bold text-slate-800 mt-0.5 truncate">Rp
                        {{ number_format($saldo['hutang_modal'], 0, ',', '.') }}</p>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div class="bg-white rounded-xl shadow border p-5 flex items-start gap-4">
                ...
                <div class="min-w-0">
                    ...
                    <p class="text-xl font-bold text-slate-800 mt-0.5 truncate">Rp
                        {{ number_format($ringkasan['total_hpp'], 0, ',', '.') }}</p>
                ...
                <div class="p-5">
                    ...
                    <div class="space-y-2 text-sm">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <span class="font-semibold text-slate-800">Rp
                                {{ number_format($saldo['total_pencairan_modal'], 0, ',', '.') }}</span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="text-slate-600">Total Cicilan Terbayar</span>
                            <span class="font-semibold text-slate-800">Rp
                                {{ number_format($saldo['total_cicilan_terbayar'], 0, ',', '.') }}</span>
                        </div>
                        <div class="flex justify-between items-center border-t pt-2 mt-2">
