...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // ============================================================
        // 11. MODAL & HUTANG TOKO
        // ============================================================

        DB::table('modal_hutang')->insert([
            [
                'nomor'             => 'MOD-001',
                'jenis'             => 'modal_sendiri',
                'nama_sumber'       => 'Modal Awal Toko',
                'nama_kreditur'     => null,
                'telepon_kreditur'  => null,
                'jumlah_total'      => 50000000,
                'tanggal_diterima'  => '2025-01-01',
                'jangka_bulan'      => null,
                'bunga_persen'      => null,
                ...
                'status'            => 'aktif',
                'dilunasi_pada'     => null,
                'catatan'           => 'Modal pribadi pemilik untuk pembelian stok awal dan operasional',
                'user_id'           => 1,
                'created_at'        => $now,
                'updated_at'        => $now,
            ],
            [
                'nomor'             => 'HUT-001',
                'jenis'             => 'pinjaman',
                'nama_sumber'       => 'KUR BRI 2025',
                'nama_kreditur'     => 'Bank BRI Cabang Sleman',
                'telepon_kreditur'  => '0274-868222',
                'jumlah_total'      => 25000000,
                'tanggal_diterima'  => '2025-01-05',
                'jangka_bulan'      => 24,
                'bunga_persen'      => 6.00,
                'cicilan_per_bulan' => 1118500,
                'tanggal_jatuh_tempo' => '2027-01-05',
                'sudah_dibayar'     => 0,
                'sisa_hutang'       => 25000000,
                'status'            => 'aktif',
                'dilunasi_pada'     => null,
                'catatan'           => 'KUR Mikro BRI untuk tambahan modal kerja, bunga 6%/tahun',
                'user_id'           => 1,
                'created_at'        => $now,
                'updated_at'        => $now,
            ],
